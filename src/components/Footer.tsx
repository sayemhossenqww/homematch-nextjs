  ...
  return (
    <footer className="footer">
      ...
      <div className="sitelinks-div footer">
        <Link href="/about" className="site-links">About Us</Link>
        <Link href="/terms-of-use" className="site-links">Terms of Use</Link>
        <Link href="/privacy-policy" className="site-links">Privacy Policy</Link>
      </div>
    </footer>
  );
}
